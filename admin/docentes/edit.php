...
<div class="content-wrapper">
    ...
    <div class="container-fluid">
        <div class="row">
            <h1>Modificación del docente: <?php echo $nombres." ".$apellido;?></h1>
        </div>
                ...
                <div class="card card-outline card-success">
                    <div class="card-header">
                        ...
                        <div class="card-body">
                            ...
                            <form action="<?php echo APP_URL;?>/app/controllers/docentes/update.php" method="post">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="email" value = "<?php echo $correo;?>" name = "email" class = "form-control"   required>
                                ...
                                <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" value = "<?php echo $especialidad;?>" name = "especialidad" class = "form-control"   required>
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="number" value = "<?php echo $antiguedad;?>" name = "antiguedad" class = "form-control"   required>
