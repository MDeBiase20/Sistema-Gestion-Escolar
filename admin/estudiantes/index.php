                                        ...
                                        <tr>
                                            ...
                                            <td style = "text-align:center">
                                                <div class="btn-group" role="group" aria-label="Basic mixed styles example">
                                                 ...
                                                 <!--   <form action="<?php echo APP_URL;?>/app/controllers/administrativos/delete.php" onclick="preguntar<?php echo $id_estudiantes;?>(event)" method="post" id="miFormulario<?php echo $id_estudiantes;?>">
