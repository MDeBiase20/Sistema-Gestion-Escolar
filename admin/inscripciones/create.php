...
<div class="content-wrapper">
    ...
    <div class="content">
        <div class="container-fluid">
            ...
            <form action="<?php echo APP_URL;?>/app/controllers/inscripciones/create.php" method="post">
                        <!-- DATOS PERSONALES-->
                        <div class="row">
                            <div class="col-md-12">
                                                ...
                                                <div class="form-group">
                                                        ...
                                                        <select name="nivel_id" id="" class = "form-control">
                                                            <?php
                                                                ...
                                                                <option value="<?php echo $nivel['id_nivel'];?>"><?php echo $nivel['nivel']." - ".$nivel['turno'];?></option>
                                                            <?php    
                                                                }
                                                                ?>
                                                        </select>
                                                    ...
                                                    <label for="">Grado</label>
                                                        ...
                                                        <select name="grado_id" id="" class = "form-control">
                                                            <?php
                                                                ...
                                                                <option value="<?php echo $grado['id_grado'];?>"><?php echo $grado['curso']." | paralelo ".$grado['paralelo'];?></option>
                                                            <?php    
                                                                }
                                                                ?>
                                                        </select>
